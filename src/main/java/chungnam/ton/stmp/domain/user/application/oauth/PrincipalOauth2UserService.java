package chungnam.ton.stmp.domain.user.application.oauth;
...
import chungnam.ton.stmp.domain.user.domain.oauth.KakaoUserInfo;
import chungnam.ton.stmp.domain.user.domain.oauth.OAuth2UserInfo;
